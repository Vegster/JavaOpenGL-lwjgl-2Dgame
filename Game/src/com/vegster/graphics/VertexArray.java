...
public class VertexArray {
	...
	public VertexArray(float[] vertics, byte[] indices, float[] textureCoordinates)
	{
		...
		glBufferData(GL_ARRAY_BUFFER, BufferUtils.createFloatBuffer(vertics), GL_STATIC_DRAW);
